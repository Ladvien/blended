...
| Pure test layer | 690 passed, 1 skipped, 1 xfailed (5.1 s) | `make test-pure`, run 2026-09-10 at `8450842` |
...
| Context per call | bmb qwen3.8-27b tokenizer, 2026-09-10, working agreement v14: system prompt 4,482 (no operations section since OT-24); tools 9,245 on the OpenAI/Ollama lanes (op tools 7,904), 10,485 as the Claude Code envelope; static per call 13,727 / 14,967 before scene and history | `scripts/context_composition.py` |
